...
public class PersonajeAnimaciones : MonoBehaviour
{
    ...
    //En el else forzamos a que se muestre la animación de derrotado, que
    //como vemos en el tree de la animacion se va desde Idle, en el caso
    //(por ejemplo) de que nos ataquen y nos quedemos sin vida.
