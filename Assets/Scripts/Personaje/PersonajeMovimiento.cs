...
public class PersonajeMovimiento : MonoBehaviour
{
    ...
    //Para que no se mueva el personaje una vez está derrotado:
    ...
    private void Update()
    {
        //Antes de que se ejecute todo este código, debemos asegurarnos
        //que nuestro personaje tiene vida. Si no tiene vida, entonces
        //le decimos que no se mueva y cerramos el Update.
