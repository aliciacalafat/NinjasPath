...
public class Inventario : Singleton<Inventario>
{
    ...
    //En el panel de Crafting Info, en la sección de Materiales, para mostrar la
    //cantidad que se necesita y cantidad que tenemos en nuestro inventario. 
    //Ponemos la lógica aquí porque necesitamos saber cuánto tenemos del item para
    //craftear.
    //Primero creamos una lista con todos los indexes que tengan el mismo 
    //identificador de itemID. Con un ciclo foreach recorremos todos los indexes y
    //sumamos una cantidad de ese itemID.
