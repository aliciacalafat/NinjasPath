...
public class ItemArma : InventarioItem
{
    ...
    //Para cuando se craftea un arma, me tendrá que poner lo siguiente.
    public override string DescripcionItemCrafting()
    {
        string descripcion = $"- Porcentaje Crítico: {Arma.ChanceCritico}%\n" +
                             $"- Porcentaje Bloqueo: {Arma.ChanceBloqueo}%";
        return descripcion;
    }
}
